    ...
    <section id="portfolio" className="py-32 relative w-full bg-transparent">
      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        >
          ...
          <motion.p 
            variants={fadeInUp}
            className="text-gray-400 text-sm max-w-xs text-right mt-4 md:mt-0 font-light"
          >
        ...
        {selectedProject && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-6xl max-h-[90vh] bg-[#0C0C0E] border border-white/10 shadow-2xl overflow-hidden rounded-sm flex flex-col md:flex-row"
              ...
              <div className="flex-1 p-6 md:p-12 overflow-y-auto">
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-white">{selectedProject.tools || "Premiere Pro"}</p>
                  </div>
                </div>
...
const ProjectCard: React.FC<{
  ...
  return (
    ...
    >
      <motion.div 
        className="relative aspect-[9/16] bg-black rounded-xl overflow-hidden border border-white/5"
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 z-10 translate-y-4 group-hover:translate-y-0 transition-transform duration-300 pointer-events-none">
          ...
          <h3 className="text-xl font-display font-bold text-white leading-tight drop-shadow-lg">
            {project.title}
          </h3>
        </div>
