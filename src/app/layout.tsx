  ...
  return (
    <html lang="nl">
      <head>
        ...
        <meta property="og:description" content="Professionele video editing en social media content door MTZ Media." />
        ...
        <meta name="twitter:description" content="Professionele video editing en social media content door MTZ Media." />
